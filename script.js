...
function processMessage(message) {
  ...
  if (message.includes('hello') || message.includes('hi') || message.includes('hey')) {
    ...
    return "I can help you with: adding items, editing items, deleting items, searching inventory, changing themes, and managing quantities. What would you like to know about?";
      ...
      return "you can give your feed back to the number" phoneNumber="6366739780" "it will be known to the developer as soon as possible any negative or positive  feedback we are willing to accept and  we will promise to make it a more improved version  ";
    }
